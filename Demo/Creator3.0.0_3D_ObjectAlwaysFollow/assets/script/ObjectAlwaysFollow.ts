...
import { _decorator, Component, Node, systemEvent, SystemEvent, SystemEventType, EventKeyboard, macro, Vec3, tween, Quat } from 'cc';
...
export class ObjectAlwaysFollow extends Component {
    ...
    start () {
        systemEvent.on(SystemEvent.EventType.KEY_UP, this.onKeyUPEvent, this);
    }
