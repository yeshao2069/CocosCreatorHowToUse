    ...
    execute: function () {
      ...
      _export("player", player = (_dec = ccclass('player'), _dec(_class = (_class2 = class player extends Component {
        ...
        changeInstancingBatch(isEnable) {
          let arrInstancing = this.node.getComponentsInChildren(_crd && instacingMaterial === void 0 ? (_reportPossibleCrUseOfinstacingMaterial({
            error: Error()
...
//# sourceMappingURL=8bf90a0d89a3a0467ef0116b185bbcc3387027d6.js.map