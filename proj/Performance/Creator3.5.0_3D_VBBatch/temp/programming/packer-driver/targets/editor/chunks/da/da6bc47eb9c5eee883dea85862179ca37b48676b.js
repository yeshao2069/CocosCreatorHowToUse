System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Camera, Tween, Vec3, profiler, sys, player, ResManager, StorageManager, gameLogic, constants, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, CAMERA_MOVE_PER_PERSON, ANTI_KEY, ARRNAME_KEY, playerManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("playerManager", playerManager = (_dec = ccclass('playerManager'), _dec2 = property(Camera), _dec(_class = (_class2 = class playerManager extends Component {
        constructor(...args) {
          super(...args);
          this.arrModel = [];
          this.arrName = [];
        ...
        set enableVBB(value) {
          ...
          this.node.children.forEach(nodePlayer => {
            let playerScript = nodePlayer.getComponent(_crd && player === void 0 ? (_reportPossibleCrUseOfplayer({
              error: Error()
            }), player) : player);
        ...
        start() {
          this.arrName = (_crd && StorageManager === void 0 ? (_reportPossibleCrUseOfStorageManager({
            error: Error()
          }), StorageManager) : StorageManager).instance.getGlobalData(ARRNAME_KEY) || ["altman", "clown", "cocosWalk", "kulou", "shitouWalk", "soldier"];
        ...
        updatePlayerNumber(num) {
          ...
          if (num > this.people) {
            ...
            for (let i = 0; i < addNum; i++) {
              ...
              let playerScript = model.getComponent(_crd && player === void 0 ? (_reportPossibleCrUseOfplayer({
                error: Error()
              }), player) : player);
...
//# sourceMappingURL=da6bc47eb9c5eee883dea85862179ca37b48676b.js.map