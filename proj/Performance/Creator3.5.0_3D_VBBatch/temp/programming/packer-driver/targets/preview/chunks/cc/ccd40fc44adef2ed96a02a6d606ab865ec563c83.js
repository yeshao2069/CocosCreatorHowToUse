    ...
    execute: function () {
      ...
      _export("player", player = (_dec = ccclass('player'), _dec(_class = (_class2 = class player extends Component {
        ...
        changeVBBatch(isEnable) {
          var arrVBB = this.node.getComponentsInChildren(_crd && vbMaterial === void 0 ? (_reportPossibleCrUseOfvbMaterial({
            error: Error()
        ...
        changeShadow(isEnable) {
          var arrModel = this.node.getComponentsInChildren(SkinnedMeshRenderer);
...
//# sourceMappingURL=ccd40fc44adef2ed96a02a6d606ab865ec563c83.js.map