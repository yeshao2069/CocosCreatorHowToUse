System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, profiler, Label, SpriteFrame, Sprite, EditBox, sys, playerManager, confirmBox, constants, StorageManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _crd, ccclass, property, LOWMODEL_KEY, SHADOW_KEY, ARRNAME_KEY, mainUI;
  ...
  return {
    ...
    execute: function () {
      ...
      LOWMODEL_KEY = 'low-model';
      SHADOW_KEY = 'shadow';
      ARRNAME_KEY = 'arrName';

      _export("mainUI", mainUI = (_dec = ccclass('mainUI'), _dec2 = property(_crd && playerManager === void 0 ? (_reportPossibleCrUseOfplayerManager({
        error: Error()
      }), playerManager) : playerManager), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(SpriteFrame), _dec13 = property(SpriteFrame), _dec14 = property(Sprite), _dec15 = property(Sprite), _dec16 = property(Sprite), _dec17 = property(Sprite), _dec18 = property(Node), _dec19 = property(Label), _dec20 = property(EditBox), _dec(_class = (_class2 = class mainUI extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "spLowModel", _descriptor16, this);

          _initializerDefineProperty(this, "nodeConfirmBox", _descriptor17, this);

          _initializerDefineProperty(this, "lbVersion", _descriptor18, this);

          _initializerDefineProperty(this, "numberInput", _descriptor19, this);
        ...
        start() {
          ...
          this.enableLowModel = (_crd && StorageManager === void 0 ? (_reportPossibleCrUseOfStorageManager({
            error: Error()
          }), StorageManager) : StorageManager).instance.getGlobalData(LOWMODEL_KEY) || false;
          this.manager.enableLowModel = this.enableLowModel;
          this.enableShadow = (_crd && StorageManager === void 0 ? (_reportPossibleCrUseOfStorageManager({
            error: Error()
          }), StorageManager) : StorageManager).instance.getGlobalData(SHADOW_KEY);
        }
        ...
        switchAliasing() {
          //跳出提示框
          var str = this.manager.enableAntiAliasing ? '关闭' : '开启';
        ...
        switchLowModel() {
          ...
          (_crd && StorageManager === void 0 ? (_reportPossibleCrUseOfStorageManager({
            error: Error()
          }), StorageManager) : StorageManager).instance.setGlobalData(LOWMODEL_KEY, this.enableLowModel);

          if (this.enableLowModel) {
            (_crd && StorageManager === void 0 ? (_reportPossibleCrUseOfStorageManager({
              error: Error()
            }), StorageManager) : StorageManager).instance.setGlobalData(ARRNAME_KEY, ["altman", "clown", "soldier"]);
          } else {
            (_crd && StorageManager === void 0 ? (_reportPossibleCrUseOfStorageManager({
              error: Error()
            }), StorageManager) : StorageManager).instance.setGlobalData(ARRNAME_KEY, ["altman", "clown", "cocosWalk", "kulou", "shitouWalk", "soldier"]);
          }

          (_crd && StorageManager === void 0 ? (_reportPossibleCrUseOfStorageManager({
            error: Error()
          }), StorageManager) : StorageManager).instance.setGlobalData(SHADOW_KEY, this.enableShadow);

          if (sys.isBrowser) {
            window.location.reload();
          } else if (sys.platform === sys.WECHAT_GAME) {
            console.log('reload!'); // @ts-ignore
        ...
        onNumberInputEnd() {
          var num = Number.parseInt(this.numberInput.string);
          this.manager.updatePlayerNumber(num);
        }

        onNumberClick(evt, data) {
          var num = Number.parseInt(data);
          this.manager.updatePlayerNumber(num);
        }
      ...
      }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, "spLowModel", [_dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, "nodeConfirmBox", [_dec18], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, "lbVersion", [_dec19], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor19 = _applyDecoratedDescriptor(_class2.prototype, "numberInput", [_dec20], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=39a0b3db8cd28758043144d5932c5c702c38ad79.js.map