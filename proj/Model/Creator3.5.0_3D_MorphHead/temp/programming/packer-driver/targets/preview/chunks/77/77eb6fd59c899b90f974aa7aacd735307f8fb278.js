    ...
    execute: function () {
      ...
      _export("MorphController", MorphController = (_dec = ccclass('MorphController'), _dec2 = property({
        ...
        start() {
          ...
          var firstNonNullSubMeshMorph = this._morph.subMeshMorphs.find(subMeshMorph => !!subMeshMorph);
        ...
        initUI() {
          for (var i = 0; i < this._totalTargets; i++) {
            ...
            var nameLabel = (_find = find('Name', controlItem)) == null ? void 0 : _find.getComponent(Label);

            if (nameLabel) {
              nameLabel.string = '' + i;
            }

            var slider = (_find2 = find('Slider', controlItem)) == null ? void 0 : _find2.getComponent(Slider);
...
//# sourceMappingURL=77eb6fd59c899b90f974aa7aacd735307f8fb278.js.map