  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", Draw = (_dec = ccclass('Draw'), _dec(_class = class Draw extends Component {
        ...
        BeamBoom() {
          let paint3 = this.GetNewPaint(); // 烟花开始
        ...
        GradientCurve(paint, config, inter, p0, p1, p2, t = 0, callBack = null) {
          let pt = 0;
...
//# sourceMappingURL=cef13de6862944bfaafa502eb19bafee962d49f0.js.map