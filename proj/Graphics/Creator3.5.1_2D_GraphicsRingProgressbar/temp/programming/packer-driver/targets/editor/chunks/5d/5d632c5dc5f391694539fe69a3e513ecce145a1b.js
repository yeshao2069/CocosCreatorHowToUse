System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, Graphics, Color, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _crd, ccclass, property, requireComponent, executeInEditMode, help, menu, ArcProgressBar;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", ArcProgressBar = (_dec = ccclass('ArcProgressBar'), _dec2 = requireComponent(cc.Graphics), _dec3 = property(Graphics), _dec4 = property(), _dec5 = property({
        tooltip: CC_DEV && '半径'
      }), _dec6 = property(), _dec7 = property({
        tooltip: CC_DEV && '顺时针方向'
      }), _dec8 = property(), _dec9 = property({
        tooltip: CC_DEV && '开始角度 (基于 y 轴)'
      }), _dec10 = property(), _dec11 = property({
        tooltip: CC_DEV && '范围 (角度)'
      }), _dec12 = property(), _dec13 = property({
        tooltip: CC_DEV && '线宽'
      }), _dec14 = property(), _dec15 = property({
        range: [0, 1],
        step: 0.01,
        tooltip: CC_DEV && '进度 (0 ~ 1)'
        ...
        type: Color,
        tooltip: CC_DEV && '进度颜色'
      }), _dec(_class = _dec2(_class = executeInEditMode(_class = (_class2 = class ArcProgressBar extends Component {
        constructor(...args) {
          super(...args);
        ...
        to(duration, progress) {
          return new Promise(res => {
            ...
            this.curTween = cc.tween(this).to(duration, {
              progress
            }).call(() => {
              this.curTween = null;
              this.curTweenRes = null;
      ...
      }), _applyDecoratedDescriptor(_class2.prototype, "progressColor", [_dec21], Object.getOwnPropertyDescriptor(_class2.prototype, "progressColor"), _class2.prototype)), _class2)) || _class) || _class) || _class));
...
//# sourceMappingURL=5d632c5dc5f391694539fe69a3e513ecce145a1b.js.map