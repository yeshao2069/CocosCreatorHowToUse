System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, Label, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, LargeSystemFontText;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "0c845MOPsZDzYjs3WLw77tW", "LargeSystemFontText", undefined);
      ...
      _export("LargeSystemFontText", LargeSystemFontText = (_dec = ccclass('LargeSystemFontText'), _dec2 = property(Label), _dec(_class = (_class2 = class LargeSystemFontText extends Component {
        constructor(...args) {
          super(...args);
        ...
        start() {
          ...
          let longtext = `话说天下大势，分久必合，合久必分。周末七国分争，并入于秦。及秦灭之后，楚、汉分争，又并入于汉。汉朝自高祖斩白蛇而起义，一统天下。后来光武中兴，传至献帝，遂分为三国。推其致乱之由，殆始于桓、灵二帝。桓帝禁锢善类，崇信宦官。及桓帝崩，灵帝即位，大将军窦武、太傅陈蕃，共相辅佐。时有宦官曹节等弄权，窦武、陈蕃谋诛之，作事不密，反为所害。中涓自此愈横。
        ...
        人情势利古犹今，谁识英雄是白身？安得快人如翼德，尽诛世上负心人！毕竟董卓性命如何，且听下文分解。`;
          longtext = longtext.split("\n").map(x => x.trim()).filter(x => x.length > 0).map(x => this.split_by_length(x, 40)).join("\n");
          this.scheduleOnce(() => {
            this.label.string = longtext;
          }, 0);
        }

        split_by_length(str, len) {
          let m = Array.from(str);
          let idx = 0;
          let total = m.length;
          let ret = [];

          while (idx < total) {
            let l = Math.min(len, total - idx);
...
//# sourceMappingURL=95e5db9a00939f4951787d6e72ac8040bb5b45dd.js.map