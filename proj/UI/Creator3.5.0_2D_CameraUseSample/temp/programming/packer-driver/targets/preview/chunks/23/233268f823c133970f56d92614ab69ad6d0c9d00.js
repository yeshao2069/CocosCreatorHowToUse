System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, Camera, Sprite, Node, Slider, RenderTexture, tween, UITransform, SpriteFrame, Label, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, CameraSample;
    ...
    execute: function () {
      ...
      _export("default", CameraSample = (_dec = ccclass('CameraSample'), _dec2 = property(Camera), _dec3 = property(Sprite), _dec4 = property(Node), _dec5 = property(Slider), _dec6 = property(Slider), _dec7 = property(Slider), _dec(_class = (_class2 = class CameraSample extends Component {
        ...
        onLoad() {
          ...
          var spCameraUITrans = this.sp_camera.node.getComponent(UITransform);
          renderTex.reset({
            width: spCameraUITrans.width,
            height: spCameraUITrans.height
          });
          var spriteframe = this.sp_camera.spriteFrame;
        ...
        onSliderChange(slider) {
          switch (slider) {
            case this.sl_scale:
              {
                var zoomRatio = this.sl_scale.progress * 2;
            ...
            case this.sl_h:
              {
                var newCameraPos = this.camera.node.getPosition();
            ...
            case this.sl_v:
              {
                var _newCameraPos = this.camera.node.getPosition();

                _newCameraPos.y = (this.sl_v.progress - 0.5) * this.node.getComponent(UITransform).height;
                this.camera.node.setPosition(_newCameraPos);
                break;
              }
          }
        }
        ...
        updateSliderLabel(slider) {
          var label = slider.node.getChildByName('label').getComponent(Label);
...
//# sourceMappingURL=233268f823c133970f56d92614ab69ad6d0c9d00.js.map