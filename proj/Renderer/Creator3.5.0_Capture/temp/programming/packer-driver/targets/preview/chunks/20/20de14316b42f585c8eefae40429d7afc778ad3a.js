System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "204ee6zwYRKKLQIxZe3Wwpz", "Canvas2Image", undefined);
      ...
      _export("Canvas2Image", Canvas2Image = (_dec = ccclass('Canvas2Image'), _dec(_class = class Canvas2Image {
        static getInstance() {
          ...
          var genBitmapImage = function genBitmapImage(oData) {
            ...
            0x42, 0x4D, // DWORD bfType -- The size, in bytes, of the bitmap file
            ...
            54, 0, 0, 0]; //  typedef struct tagBITMAPINFOHEADER {
            //  	DWORD biSize;
            //  	LONG  biWidth;
            //  	LONG  biHeight;
            //  	WORD  biPlanes;
            ...
            var BITMAPINFOHEADER = [// DWORD biSize -- The number of bytes require by the structure
            ...
            biHeight & 0xff, biHeight >> 8 & 0xff, biHeight >> 16 & 0xff, biHeight >> 24 & 0xff, // WORD biPlanes -- The number of planes for the target deviecs. The value must be set to 1
            1, 0, // Word biBitCount -- The number of bits-per-pixel, 24 bits-per-pixel
            ...
            0, 0, 0, 0, // DWORD biSizeImage -- The size, in bytes, of the image. This may be set to zero for BI_REG bitmaps
...
//# sourceMappingURL=20de14316b42f585c8eefae40429d7afc778ad3a.js.map