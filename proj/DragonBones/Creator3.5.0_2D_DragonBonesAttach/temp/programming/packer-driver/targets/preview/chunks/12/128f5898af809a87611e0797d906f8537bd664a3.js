    ...
    execute: function () {
      ...
      _export("default", _class = (_dec = ccclass('DragonBonesAttach'), _dec2 = property({
        ...
        createSocket(name, color) {
          ...
          var socketNode = instantiate(this.targetPrefab);
          newNode.addChild(socketNode);
          dbNode.target = newNode;
          var child = newNode;
          child.parent = this.node;
          socketNode.name = name;
          var sp = socketNode.getComponent(Sprite);
          sp.color = color;
          return dbNode;
        }
...
//# sourceMappingURL=128f5898af809a87611e0797d906f8537bd664a3.js.map