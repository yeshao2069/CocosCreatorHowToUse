System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, Material, Collider, MeshRenderer, Label, VerticalTextAlignment, UITransform, Size, Color, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, TriggerTest;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "76119OF0HZA1KNhInWQdb+t", "TriggerTest", undefined);
      ...
      _export("TriggerTest", TriggerTest = (_dec = ccclass("TriggerTest"), _dec2 = property({
        ...
        onTriggerForUseMaterial(event) {
          if (event.type == 'onTriggerEnter') {
            var modelCom = event.otherCollider.node.getComponent(MeshRenderer);

            if (modelCom) {
              modelCom.material = this.enterMat;
            }
          } else if (event.type == 'onTriggerExit') {
            var _modelCom = event.otherCollider.node.getComponent(MeshRenderer);
...
//# sourceMappingURL=697cfcaecce81a50461fdf194ea46a99b1951407.js.map