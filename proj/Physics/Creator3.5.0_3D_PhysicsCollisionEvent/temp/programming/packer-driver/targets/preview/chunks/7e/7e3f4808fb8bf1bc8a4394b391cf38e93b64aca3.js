System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "dbda1JA2nBBS493ELE+7Uf4", "SupportPhyiscs", undefined);
        ...
        start() {
          ...
          switch (this.support) {
            ...
            case SupportPhysics.AMMO:
              if (PhysicsSystem.PHYSICS_BULLET) return;
              this.node.active = false;
              break;
            ...
            case SupportPhysics.BUILTIN_AMMO:
              if (PhysicsSystem.PHYSICS_BUILTIN || PhysicsSystem.PHYSICS_BULLET) return;
              this.node.active = false;
              break;

            case SupportPhysics.CANNON_AMMO:
              if (PhysicsSystem.PHYSICS_CANNON || PhysicsSystem.PHYSICS_BULLET) return;
              this.node.active = false;
              break;
          }
        }
...
//# sourceMappingURL=7e3f4808fb8bf1bc8a4394b391cf38e93b64aca3.js.map