...
export class GameCtr extends Component {
    ...
    start () {
        ...
        this._timingLb = this.gamePanel.getChildByName('TimingLabel').getComponent(Label);
        this._scoreLb = this.gamePanel.getChildByName('ScoreLabel').getComponent(Label);
