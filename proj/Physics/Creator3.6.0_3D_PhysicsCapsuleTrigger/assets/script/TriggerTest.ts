import { _decorator, Component, Node, Quat, ITriggerEvent,
    Material, Collider, MeshRenderer, Label, VerticalTextAlignment, 
    UITransformComponent, Size, Color } from "cc";
...
export class TriggerTest extends Component {
    ...
    @property({ type: Label, visible: function (this: TriggerTest) { return this.USE_LABEL; } })
    label: Label = null as any;
