    ...
    execute: function () {
      ...
      _export("GetScriptFunction", GetScriptFunction = (_dec = ccclass('GetScriptFunction'), _dec2 = property(Node), _dec3 = property(Label), _dec(_class = (_class2 = class GetScriptFunction extends Component {
        ...
        onLoad() {
          ...
          this.testLabel.string = "Private Function " + propFuncMap + "\nPublic Function " + publicFuncMap + "\nUnsort Function " + unsortFuncMap + "\nProp Function " + propFuncMap;
        }
...
//# sourceMappingURL=79564456aa55c3b93d56eeeadc4a064632c406a9.js.map