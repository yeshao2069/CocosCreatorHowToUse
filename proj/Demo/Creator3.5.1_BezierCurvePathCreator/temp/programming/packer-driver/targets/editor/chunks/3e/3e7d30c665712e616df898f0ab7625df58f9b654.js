System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Prefab, Label, Color, Graphics, EditBox, EventMouse, UITransform, Size, sys, Vec3, tween, Ident, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _crd, ccclass, property, DrawBezier;
    ...
    execute: function () {
      ...
      _export("DrawBezier", DrawBezier = (_dec = ccclass('DrawBezier'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Label), _dec10 = property(Node), _dec11 = property(Label), _dec(_class = (_class2 = class DrawBezier extends Component {
        ...
        init() {
          ...
          this.initResolution(); // @ts-ignore

          window['BezierData'].init(this.point, this.control, this.node); // @ts-ignore

          window['BezierData'].setBezierCurveRunTime(Number(this.runTimeInputBox.string)); // @ts-ignore
        ...
        initNodeEvents() {
          ...
          this.moveBtn.parent.ident = (_crd && Ident === void 0 ? (_reportPossibleCrUseOfIdent({
            error: Error()
          }), Ident) : Ident).window; // @ts-ignore

          window['NodeEvents'].addDragEvents(this.box); // @ts-ignore
        ...
        saveBezierPathToJson(name) {
          if (sys.isBrowser) {
            ...
            if (window.webkitURL != null) {
              ...
              downloadLink.href = window.URL.createObjectURL(textFileAsBlob); // @ts-ignore
        ...
        setRunTime(str) {
          ...
          this.prveRunTime = num; // @ts-ignore
        ...
        setCurveSmoothness(str) {
          ...
          this.prvePointCount = num; // @ts-ignore
...
//# sourceMappingURL=3e7d30c665712e616df898f0ab7625df58f9b654.js.map