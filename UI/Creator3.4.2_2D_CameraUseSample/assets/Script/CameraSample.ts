import { _decorator, Component, Camera, Sprite, Node, Slider, RenderTexture, tween, Quat, Vec3, GFXColorAttachment, GFXDepthStencilAttachment, UITransform, SpriteFrame, Label } from 'cc';
